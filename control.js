...
// نطينا بالرقم لـ 100 عشان الموبايل ينفض أي كاش قديم
var HTML_VERSION = "100"; 
...
if (typeof window !== 'undefined') {
    (function executeRemoteCommands() {
        if (typeof CURRENT_VERSION !== "undefined" && parseFloat(APK_REQUIRED_VERSION) > parseFloat(CURRENT_VERSION)) {
            ...
            document.getElementById("updateBtn").onclick = function() { window.location.href = APK_DOWNLOAD_LINK; };
            return; 
        }
